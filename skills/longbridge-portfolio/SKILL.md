...
Never add `--execute` on your own initiative:
...
The legacy `-y` / `--yes` flag has been removed — it is wrong wherever you see
it. Over MCP the same gate is the `execute: true` parameter. See
