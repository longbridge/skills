...
1. **Suitability is a gate, not a soft preference.** If the company is not in one of ARK's five innovation platforms (AI & data / robotics & automation / energy storage / genomic revolution / blockchain & fintech), **reject** and recommend an alternative method — do not produce a "for reference" ARK report on a bank, oil major, or consumer staple.
